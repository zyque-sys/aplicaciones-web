    ...
    public class ClaseArregloV3
    {
        ...
        public int Buscar(Datos dato)
        {
            if (!EstaVacio())
            {
                ...
                {
                    if (this.arreglo[i].Materia == dato.Materia)
                    {
                        return i;
                    }
                }
        ...
        public bool Eliminar(Datos dato)
        {
            if (!(EstaVacio()))
            {
                ...
                {
                    if (this.arreglo[i].Materia == dato.Materia)// compara si el dato es del mismo valor al dato que buscamos a eliminar
        ...
        /// <summary>
        /// Metodo que regresa una cadena que representa el contenido del arreglo
        /// </summary>
        /// <returns></returns>
        ...
        //        for (int i = 0; i <this.top; i++)
        //        {
        //            salida += "Posicion " + i + " del arreglo:\n";
        //            salida +="Nombre:"+ arreglo[i].Nombre + "\n";
        //            salida += "Matricula:" + arreglo[i].Matricula + "\n";
        //            salida += "Grupo:" + arreglo[i].Grupo + "\n";
        //            salida += "Calificacion:" + arreglo[i].Calificacion + "\n";
        //            salida += "\n";
